"""
Bollinger Bands 15-minute signal generator.
...
class BollingerBands15MinSignalGenerator:
    """
    Bollinger Bands-based signal generator using 15-minute candles.
    ...
    def __init__(self, period: int = 20, std_dev: float = 2.0, 
        ...
        """
        Initialize Bollinger Bands 15-minute signal generator.
        ...
        self.name = "bollinger_bands_15min"
    ...
    def _load_coin_parameters(self, coin: str):
        ...
        params = self.backtest_loader.get_parameters(coin, "bollinger_bands-15min")
