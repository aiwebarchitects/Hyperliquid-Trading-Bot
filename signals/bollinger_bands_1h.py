"""
Bollinger Bands 1-hour signal generator.
...
class BollingerBands1HSignalGenerator:
    """
    Bollinger Bands-based signal generator using 1-hour candles.
    ...
    def __init__(self, period: int = 20, std_dev: float = 2.0, 
        ...
        """
        Initialize Bollinger Bands 1-hour signal generator.
    ...
    def _load_coin_parameters(self, coin: str):
        ...
        params = self.backtest_loader.get_parameters(coin, "bollinger_bands-1h")
